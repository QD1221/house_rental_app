...
mixin _$House {
  ...
  String? get pricePerNight => throw _privateConstructorUsedError;
...
class _$_House implements _House {
  ...
  @override
  String toString() {
    return 'House(img: $img, star: $star, title: $title, pricePerNight: $pricePerNight, location: $location, rooms: $rooms, area: $area)';
  }
